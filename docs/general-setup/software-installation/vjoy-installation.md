...
## vJoy Installation Video

!!! warning
    This general guide that explains what vjoy is and how to get it setup in general. Please refer to [Software Configuration](software-configuration.md) for what settings to use when loading your binds.
